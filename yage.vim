...
badd +13 Makefile
badd +26 include/events/event_manager.h
badd +1 tests/graphics/graphics_manager.unit.cpp
badd +13 include/tests/unit/graphics/graphics.fixture.h
badd +11 tests/unit/graphics/graphics_manager.unit.cpp
badd +28 CMakeLists.txt
badd +30 include/engine/state_machine.implementation.h
badd +0 src/engine/state_machine.implementation.cpp
argglobal
silent! argdel *
edit include/engine/state_machine.implementation.h
...
silent! normal! zE
let s:l = 37 - ((18 * winheight(0) + 17) / 35)
...
wincmd w
argglobal
edit src/engine/state_machine.implementation.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
